	...
	<div class="row">
		<div class="col-md-6">
			...
			<form:form method="post" modelAttribute="student"
				action="student/save" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="inputEmail3">Date
						of Birth :</label>
					<div class="col-sm-9">
						<form:input type="text" path="dateOfBirth"
							placeholder="Date of Birth" class="form-control date" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label" for="inputEmail3">Father
						Name :</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="inputEmail3">Mother
						Name :</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="inputEmail3">Address
						:</label>
					<div class="col-sm-9">
